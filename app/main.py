...
ARIA_SYSTEM = (
    ...
    "it must be read directly. Never state what a court held. The authorities NAMED in the "
    "CURRENT LAW list and in rules 8 and 9 of this message may be relied on exactly as "
    "stated here, and no further.\n"
    ...
    "user add them: any STATE, local or foreign income-tax LIABILITY (the federal SALT "
    "itemized deduction and its cap ARE modeled); the age-based senior deduction (the app "
